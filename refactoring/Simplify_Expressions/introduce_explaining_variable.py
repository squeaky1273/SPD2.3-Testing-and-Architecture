...
iris_width = 20.2  # [mm]
iris_height = 19.7 # [mm]
ideal = math.pi*iris_width/2*iris_height/2 / eye_size >= 0.69
wanted_size = eye_size > 0.45
wanted_dimension = eye_height/eye_width >= 0.59

if wanted_size and ideal and wanted_dimension:
